...
public class chatsList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference membersList = FirebaseDatabase.getInstance().getReference("Users/" + LoginActivity.userUid + "/Chats");

        membersList.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
